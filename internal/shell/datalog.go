...
// execute built-in; its text matches how java's script harness
// prints the uncaught DatalogException.
...
// boot environment (user bindings are not visible, as in java) —
// returning the compiled statement and the emitted source.
