...
func TestKernelParseTree(t *testing.T) {
	...
	// An unknown member is a type error, worded as java words it
	// (java abbreviates the recursive "file" field as "{...}",
	// where go, lacking progressive records, types it as "unit").
