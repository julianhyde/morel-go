...
// String renders a warning as morel-java's script harness does.
...
// (following morel-java's Compiles.checkPatternCoverage). It
// returns the warnings in source order and the first redundant
// error, if any.
